...
import { FaFacebookSquare, FaInstagram, FaMapMarkerAlt, FaWhatsapp } from "react-icons/fa";

export default function Home() {
  return (
    <div className={styles.pageContainer}>
      <section>
        <h1>Welcome to AppFood</h1>
        <p>
          Hello and welcome to our special culinary corner, where Italian
          tradition dances with modern creativity to give you a unique dining
          experience. With us, every dish is a taste hug, conceived with lave
      ...
      <section className={styles.contactSection}>
        <h1>Stay Updated!</h1>
        <p>
          Enter the world of AppFood by following us on social media.
          You'll always be updated on our culinary creations, special events,
          and goumet surprises. Don't miss out on a single bite! 
        </p>
